...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Offer'
        db.create_table(u'marketplace_offer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
            ('deal_offered_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deal_offered_to', to=orm['marketplace.Deal'])),
            ('deal_owned', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deal_owned', null=True, to=orm['marketplace.Deal'])),
        ...
        db.send_create_signal(u'marketplace', ['Offer'])

        # Adding field 'Deal.description'
        db.add_column(u'marketplace_deal', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'marketplace_offer')

        # Deleting field 'Deal.description'
        db.delete_column(u'marketplace_deal', 'description')
    ...
    models = {
        ...
        u'marketplace.offer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deal_offered_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deal_offered_to'", 'to': u"orm['marketplace.Deal']"}),
            'deal_owned': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'deal_owned'", 'null': 'True', 'to': u"orm['marketplace.Deal']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
