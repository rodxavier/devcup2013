...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.amount'
        db.alter_column(u'marketplace_offer', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Offer.amount'
        db.alter_column(u'marketplace_offer', 'amount', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=20, decimal_places=2))
