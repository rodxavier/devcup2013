...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.is_rejected'
        db.add_column(u'marketplace_offer', 'is_rejected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.is_rejected'
        db.delete_column(u'marketplace_offer', 'is_rejected')
